...
Route::middleware(['auth'])->group(function () {
   ...
   // Anulación
    ...
    Route::get('/configuracion-proforma', [App\Http\Controllers\ConfiguracionProformaController::class, 'edit'])->name('configuracion-proforma.edit');
    Route::post('/configuracion-proforma', [App\Http\Controllers\ConfiguracionProformaController::class, 'update'])->name('configuracion-proforma.update');

    // Imprimir Proforma
    Route::any('cotizaciones/{cotizacione}/proforma', [CotizacionController::class, 'generarProforma'])->name('cotizaciones.proforma');
    // Detalles para Modal (JSON)
    Route::get('cotizaciones/{cotizacione}/details', [CotizacionController::class, 'getDetails'])->name('cotizaciones.details');
